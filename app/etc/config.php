...
return [
    'modules' => [
        ...
        'MSP_TwoFactorAuth' => 1,
        'Perspective_Access' => 1,
        'Perspective_AddAttribute' => 1,
        'Perspective_AddAttributeCategory' => 1,
        'Perspective_AddCustomPrice' => 1,
        'Perspective_AutoRefreshCache' => 1,
        'Perspective_BuyOneClick' => 1,
        'Perspective_CancelOrder' => 1,
        'Perspective_ChangeProductName' => 1,
        'Perspective_CurrencyTransfer' => 1,
        'Perspective_Holiday' => 1,
        'Perspective_Image' => 1,
        'Perspective_NameChange' => 1,
        'Perspective_Orders' => 1,
        'Perspective_Payment' => 1,
        'Perspective_Prices' => 1,
        'Perspective_QtyProduct' => 1,
        'Perspective_SalesEndTime' => 1,
        'Perspective_Schema' => 1,
        'Perspective_Shipping' => 1,
        'Perspective_UpdateCart' => 1,
